...
root.title('Guess the Gibberish: Shrey Kharbanda')
...
game_desp= 'Game Description: Guess The Gibberish Game is a free word \n puzzle game that will exercise your brain. It has words that \n look weird, but when spoken/written sound similar to a real word. \n \n After clicking the start button, enter the answer in the box below \n and press enter.  For the next round, click on Next button '
Label(root, text=game_desp,fg='grey', bg='#ffff63', font='Helvetica 8').place(x=15, y=0)

Label(root, text='Shrey Kharbanda',fg='white', bg='#0597fe', font='Helvetica 12 bold').place(x=120, y=100)
Question_label = Label(root, text='Guess The Gibberish',fg='white', bg='#0597fe', font='Helvetica 17 bold')
Question_label.place(x=50, y=140)

time_label = Label(root, text= '15', font='Helvetica 18 bold', fg='white', bg='black')
time_label.place(x=175, y=216)
